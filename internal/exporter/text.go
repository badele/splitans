...
func ExportFlattenedText(width, nblines int, tokens []types.Token, outputEncoding string, crop *types.CropRegion) (string, error) {
...
func ExportFlattenedTextInline(width, nblines int, tokens []types.Token, outputEncoding string, crop *types.CropRegion) (string, error) {
	return exportFlattenedText(width, nblines, tokens, outputEncoding, true, crop)
}

func exportFlattenedText(width, nblines int, tokens []types.Token, outputEncoding string, inline bool, crop *types.CropRegion) (string, error) {
